...
const arducam_sensor_reg_t ov5642_RAW[]  =
{
		{0x3103,0x03},
		{0x3008,0x82},
		{0x3017,0x7f},
...
const arducam_sensor_reg_t OV5642_1280x960_RAW[]  =
{
		{0x3103,0x93},
		{0x3008,0x02},
		{0x3017,0x7f},
...
const arducam_sensor_reg_t OV5642_1920x1080_RAW[]  =
{
...
const arducam_sensor_reg_t OV5642_640x480_RAW[]  =
{
		/*
{0x3800,0x03},
{0x3801,0xE8},
...
const arducam_sensor_reg_t ov5642_320x240[]  =
{
		{0x3800 ,0x1 },
		{0x3801 ,0xa8},
		{0x3802 ,0x0 },
...
const arducam_sensor_reg_t ov5642_640x480[]  =
{
		{0x3800 ,0x1 },
		{0x3801 ,0xa8},
		{0x3802 ,0x0 },
...
const arducam_sensor_reg_t ov5642_1280x960[]  =
{
		{0x3800 ,0x1 },
		{0x3801 ,0xB0},
		{0x3802 ,0x0 },
...
const arducam_sensor_reg_t ov5642_1600x1200[]  =
{
		{0x3800 ,0x1 },
		{0x3801 ,0xB0},
		{0x3802 ,0x0 },
...
const arducam_sensor_reg_t ov5642_1024x768[]  =
{
		{0x3800 ,0x1 },
		{0x3801 ,0xB0},
		{0x3802 ,0x0 },
...
const arducam_sensor_reg_t ov5642_2048x1536[]  =
{
		{0x3800 ,0x01},
		{0x3801 ,0xb0},
		{0x3802 ,0x00},
...
const arducam_sensor_reg_t ov5642_2592x1944[]  =
{
		{0x3800 ,0x1 },
		{0x3801 ,0xB0},
		{0x3802 ,0x0 },
...
const arducam_sensor_reg_t ov5642_dvp_zoom8[] =
{
...
const arducam_sensor_reg_t OV5642_QVGA_Preview[]  =
{
		{0x3103 ,0x93},
		{0x3008 ,0x82},
		{0x3017 ,0x7f},
...
const arducam_sensor_reg_t OV5642_JPEG_Capture_QSXGA[]  =
{
...
const arducam_sensor_reg_t OV5642_1080P_Video_setting[]  =
{
		{0x3103 ,0x93},
		{0x3008 ,0x82},
		{0x3017 ,0x7f},
...
const arducam_sensor_reg_t OV5642_720P_Video_setting[]  =
{
		{0x3103 ,0x93},
		{0x3008 ,0x82},
		{0x3017 ,0x7f},
