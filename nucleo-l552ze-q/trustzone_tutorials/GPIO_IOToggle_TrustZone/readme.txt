...
The secure IO is PC.07 which corresponds to LED1 and the non-secure toggling IO is
PB.07 for LED2.
...
secure/non-secure interrupts allocations defined in partition_stm32l552xx.h file.
