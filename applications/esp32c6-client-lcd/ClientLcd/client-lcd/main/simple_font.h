/**
 * Simple 6x8 bitmap font adapted from SSD1306 driver
 * Format: 6 bytes per character, 8 pixels tall
 */
...
static const uint8_t font_extended[][6] = {
    {0x07, 0x05, 0x07, 0x00, 0x00, 0x00}, // 0: ° (degree symbol)
    {0x06, 0x09, 0x09, 0x06, 0x00, 0x00}, // 1: ³ (superscript 3)
    {0x7C, 0x08, 0x04, 0x04, 0x78, 0x00}, // 2: µ (micro/mu) - looks like lowercase 'u' with tail
};

// character code mapping for extended characters
#define CHAR_DEGREE 0xB0
#define CHAR_SUPER3 0xB3
#define CHAR_MICRO 0xB5

// Get font data for a character (returns pointer to 6-byte array)
static inline const uint8_t *get_char_font(uint8_t c)
{
    ...
    {
    case CHAR_DEGREE:
        return font_extended[0];
    case CHAR_SUPER3:
        return font_extended[1];
    case CHAR_MICRO:
        return font_extended[2];
    default:
        break;
    }

    return font_6x8[0]; // default to space
}
