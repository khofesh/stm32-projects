...
/* Private typedef -----------------------------------------------------------*/
typedef struct{
  uint16_t  CustomP2PsHdle;                    /**< fdm_p2p_server handle */
...
#define COPY_FDM_P2P_SERVER_UUID(uuid_struct)          COPY_UUID_128(uuid_struct,0x00,0x00,0xfe,0x40,0xcc,0x7a,0x48,0x2a,0x98,0x4a,0x7f,0x2e,0xd5,0xb3,0xe5,0x8f)
...
void SVCCTL_InitCustomSvc(void)
{
   ...
   * service_max_attribute_record = 1 for fdm_p2p_server +
   *                                2 for my_led_char +
  ...
  COPY_FDM_P2P_SERVER_UUID(uuid.Char_UUID_128);
...
tBleStatus Custom_STM_App_Update_Char_Ext(uint16_t Connection_Handle, Custom_STM_Char_Opcode_t CharOpcode, uint8_t *pPayload)
{
  ...
  switch (CharOpcode)
  {
    ...
    case CUSTOM_STM_LED_C:
	  ...
	  Generic_STM_App_Update_Char_Ext(Connection_Handle, CustomContext.CustomP2PsHdle, CustomContext.CustomLed_CHdle, SizeLed_C, pPayload);
    ...
    case CUSTOM_STM_SWITCH_C:
	  ...
	  Generic_STM_App_Update_Char_Ext(Connection_Handle, CustomContext.CustomP2PsHdle, CustomContext.CustomSwitch_CHdle, SizeSwitch_C, pPayload);
