...
typedef struct{
  ...
  uint16_t  CustomSen55_CHdle;                  /**< My_SEN55_Char handle */
...
#define COPY_MY_SEN55_CHAR_UUID(uuid_struct)    COPY_UUID_128(uuid_struct,0x00,0x00,0xfe,0x41,0x8e,0x22,0x45,0x41,0x9d,0x4c,0x21,0xed,0xae,0x82,0xed,0x19)
...
void SVCCTL_InitCustomSvc(void)
{
   ...
   *  My_SEN55_Char
   */
  COPY_MY_SEN55_CHAR_UUID(uuid.Char_UUID_128);
